...
class ScooterPageLocators(BasePageLocators):
    QUESTION_1 = (By.XPATH, ".//*[@id='accordion__heading-0']")
    QUESTION_2 = (By.XPATH, ".//*[@id='accordion__heading-1']")
    QUESTION_3 = (By.XPATH, ".//*[@id='accordion__heading-2']")
    QUESTION_4 = (By.XPATH, ".//*[@id='accordion__heading-3']")
    QUESTION_5 = (By.XPATH, ".//*[@id='accordion__heading-4']")
    QUESTION_6 = (By.XPATH, ".//*[@id='accordion__heading-5']")
    QUESTION_7 = (By.XPATH, ".//*[@id='accordion__heading-6']")
    QUESTION_8 = (By.XPATH, ".//*[@id='accordion__heading-7']")
